    ...
    var t = {
            ...
            2109: (t, e, r) => {
                var n = r(7854),
                    ...
                    s = r(4705);
                t.exports = function(t, e) {
                    var r, f, p, l, v, h = t.target,
                        d = t.global,
                        y = t.stat;
                    if (r = d ? n : y ? n[h] || c(h, {}) : (n[h] || {}).prototype)
                        for (f in e) {
                            if (l = e[f], p = t.noTargetGet ? (v = o(r, f)) && v.value : r[f], !s(d ? f : h + (y ? "." : "#") + f, t.forced) && void 0 !== p) {
            ...
            408: (t, e, r) => {
                ...
                t.exports = function(t, e, r) {
                    var f, p, l, v, h, d, y, m = r && r.that,
                        ...
                        j = function(t) {
                            return g ? (n(t), b ? w(t[0], t[1], S) : w(t[0], t[1])) : b ? w(t, S) : w(t)
                        };
                    if (x) f = t;
                    else {
            ...
            5948: (t, e, r) => {
                ...
                S || (n = function() {
                    ...
                    i = void 0, t && t.enter()
                }, h || y || d || !m || !g ? b && b.resolve ? ((s = b.resolve(void 0)).constructor = b, f = s.then, a = function() {
                    f.call(s, n)
                }) : a = y ? function() {
                    x.nextTick(n)
                } : function() {
                    v.call(p, n)
                } : (c = !0, u = g.createTextNode(""), new m(n).observe(u, {
                    characterData: !0
                }), a = function() {
                    u.data = c = !c
            ...
            1320: (t, e, r) => {
                ...
                (t.exports = function(t, e, r, c) {
                    var u, s = !!c && !!c.unsafe,
                        l = !!c && !!c.enumerable,
                        v = !!c && !!c.noTargetGet;
                    "function" == typeof r && ("string" != typeof e || i(r, "name") || o(r, "name", e), (u = f(r)).source || (u.source = p.join("string" == typeof e ? e : ""))), t !== n ? (s ? !v && t[e] && (l = !0) : delete t[e], l ? t[e] = r : o(t, e, r)) : l ? t[e] = r : a(e, r)
            ...
            261: (t, e, r) => {
                ...
                h && d || (h = function(t) {
                    ...
                    g.now(j(t))
                } : m && !p ? (i = (o = new m).port2, o.port1.onmessage = O, n = u(i.postMessage, i, 1)) : a.addEventListener && "function" == typeof postMessage && !a.importScripts && v && "file:" !== v.protocol && !c(T) ? (n = T, a.addEventListener("message", O, !1)) : n = w in f("script") ? function(t) {
            ...
            8674: (t, e, r) => {
                ...
                var n, o, i, a, c = r(2109),
                    ...
                    $ = I(R, (function() {
                        ...
                        return (r.constructor = {})[N] = n, !(Z = r.then((function() {})) instanceof n) || !e && D && !Y
                    })),
                    tt = $ || !S((function(t) {
                            ...
                            T((function() {
                                for (var n = t.value, o = 1 == t.state, i = 0; r.length > i;) {
                                    var a, c, u, s = r[i++],
                                        ...
                                        v = s.domain;
                                    try {
                                        f ? (o || (2 === t.rejection && at(t), t.rejection = 1), !0 === f ? a = n : (v && v.enter(), a = f(n), v && (v.exit(), u = !0)), a === s.promise ? l(K("Promise-chain cycle")) : (c = et(a)) ? c.call(a, p, l) : p(a)) : l(n)
                                    } catch (t) {
                                        v && !u && v.exit(), l(t)
                                    }
                                }
                    ...
                    nt = function(t, e, r) {
                        var n, o;
                        X ? ((n = U.createEvent("Event")).promise = e, n.reason = r, n.initEvent(t, !1, !0), s.dispatchEvent(n)) : n = {
                            promise: e,
                            reason: r
                    ...
                    ot = function(t) {
                        O.call(s, (function() {
                            ...
                            if (it(t) && (e = _((function() {
                                ...
                                })), t.rejection = k || it(t) ? 2 : 1, e.error)) throw e.value
                        }))
                    },
                    it = function(t) {
                ...
                if ($ && (z = (H = function(t) {
                        ...
                        then: function(t, e) {
                            var r = q(this),
                                n = B(j(this, H));
                            return n.ok = "function" != typeof t || t, n.fail = "function" == typeof e && e, n.domain = k ? W.domain : void 0, r.parent = !0, r.reactions.push(n), 0 != r.state && rt(r, !1), n.promise
                        },
                        catch: function(t) {
                    ...
                    a = G.then, Z || (l(G, "then", (function(t, e) {
                        var r = this;
    ...
    (() => {
        ...
        var i = function t(e) {
            ...
            a = function(e, r) {
                ...
                return new Promise((function(o, a) {
                    ...
                    c.addEventListener("load", (function(t) {
                        ...
                        var e = t.target;
                        a(new i(e))
                    })), c.open("POST", t._origin + e, !0), Object.keys(n).forEach((function(t) {
            ...
            u = function(e, r, n, i) {
                ...
                return s.append("lib_version", "3.2.0"), s.append("service_id", e), s.append("template_id", r), s.append("user_id", c), a("/api/v1.0/email/send-form", s)
            };
        const s = {
            init: e,
            send: c,
